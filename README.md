...
"**leather :level 20+ :quality uncommon+**" - show recipes with the word "leather" in their name, a minimum level requirement of 20 and a minimum quality of "green".
  ...
  ## Installation
  1. Download the following archive: [AdvancedTradeSkillWindow2.rar](https://github.com/Shellyoung/Advanced-Trade-Skill-Window/releases/download/2.1.5/AdvancedTradeSkillWindow2.rar)
  ...
  **Rene Schneider** (**Slarti** on EU-Blackhand) in 2006 
  ...
  Bug reporting: [David Côté-Tremblay](https://github.com/dctremblay)
